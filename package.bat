...
call xcopy .\resources\settings.png .\AntaresDataOrganizer-win32-ia32\resources\
call xcopy .\resources\settingshover.png .\AntaresDataOrganizer-win32-ia32\resources\
call xcopy .\resources\dataorganizer.png .\AntaresDataOrganizer-win32-ia32\resources\
call PAUSE 