...
function refreshLeft(){
	...
	if(fs.existsSync(pathLeft)){
		var leftPaths=document.getElementById('simple.01').shadowRoot.getElementById('leftPaths');
		var leftCheck=document.getElementById('simple.01').shadowRoot.getElementById('leftCheck');
...
function refreshRight(){
	...
	if(fs.existsSync(pathRight)){
		var rightPaths=document.getElementById('simple.01').shadowRoot.getElementById('rightPaths');
		var rightCheck=document.getElementById('simple.01').shadowRoot.getElementById('rightCheck');
...
function displayPaths(){
	var dispLeft=document.getElementById('simple.01').shadowRoot.getElementById('leftDisp');
	var dispRight=document.getElementById('simple.01').shadowRoot.getElementById('rightDisp');
	if(pathLeft!=""){
...
function getTextIfLib(){
	var textLib=document.getElementById('simple.01').shadowRoot.getElementById('nameLib').value;
...
Editor.Panel.extend({
  ...
  template: `
	...
	<form id="selectType" onClick="Editor.Ipc.sendToPanel('simple.01','changeType')">
	...
	<div id="leftdiv">
	<h2 onClick="Editor.Ipc.sendToPanel('simple.01','openLeft')" style="text-decoration:underline">Source :</h2>
	...
	<button type="button" class="buttonBottom add" id="addAlibLeft" onClick="Editor.Ipc.sendToPanel('simple.01','addAlibLeft')">New Acat</button>
	<button type="button" class="buttonBottom add" id="addSlibLeft" onClick="Editor.Ipc.sendToPanel('simple.01','addSlibLeft')">New Scat</button>
	<button type="button" class="buttonBottom delete" id="deleteLeft" onClick="Editor.Ipc.sendToPanel('simple.01','deleteLeft')">Delete</button>
	</div>
	<button type="button" class="buttonMove" id="moveright" title="Copy file to the right" onClick="Editor.Ipc.sendToPanel('simple.01','moveRight')">&rArr;</button>
	<button type="button" class="buttonMove" id="moveleft" title="Copy file to the left" onClick="Editor.Ipc.sendToPanel('simple.01','moveLeft')">&lArr;</button>
	<button type="button" class="buttonMove" id="concat" title="Copy the content of files from the left to the files on the right" onClick="Editor.Ipc.sendToPanel('simple.01','concat')">&oplus;</button>
	<input type="text" oninput="" id="nameLib" value="catalog name"/>
	<div id="rightdiv">
	<h2 onClick="Editor.Ipc.sendToPanel('simple.01','openRight')" style="text-decoration:underline">Sink :</h2>
	...
	<button type="button" class="buttonBottom add" id="addAlibRight" onClick="Editor.Ipc.sendToPanel('simple.01','addAlibRight')">New Acat</button>
	<button type="button" class="buttonBottom add" id="addSlibRight" onClick="Editor.Ipc.sendToPanel('simple.01','addSlibRight')">New Scat</button>
	<button type="button" class="buttonBottom delete" id="deleteRight" onClick="Editor.Ipc.sendToPanel('simple.01','deleteRight')">Delete</button>
	</div>
	</div>
  `,
  listeners: {
  ...
  messages: {
	...
	changeType(){
		var radioButtons=document.getElementById('simple.01').shadowRoot.getElementById('selectType');
	...
	deleteLeft(){
		...
		for(var i=0; i<tableft.length;i++){
			if(document.getElementById('simple.01').shadowRoot.getElementById('leftCheck').childNodes[i].firstChild.checked){
				try{
	...
	deleteRight(){
		...
		for(var i=0; i<tabright.length;i++){
			if(document.getElementById('simple.01').shadowRoot.getElementById('rightCheck').childNodes[i].firstChild.checked){
				try{
